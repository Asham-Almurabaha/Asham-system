...
class GuarantorsSkippedExport implements FromArray, WithHeadings, ShouldAutoSize, WithStyles, WithTitle
{
    /**
     ...
     *   [
     *     'row'    => 12,
     *     'values' => ['name' => '...', 'national_id' => '...', ...],
     *     'reason' => 'Duplicate phone' // أو 'messages'
     *   ],
     *   ...
     * ]
     */
