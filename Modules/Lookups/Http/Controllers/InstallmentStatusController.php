...
class InstallmentStatusController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
            ->route('installment_statuses.index')
            ->with('success', __('lookups::messages.installment_statuses.created'));
    }
    ...
    public function update(Request $request, InstallmentStatus $installmentStatus)
    {
        ...
        return redirect()
            ->route('installment_statuses.index')
            ->with('success', __('lookups::messages.installment_statuses.updated'));
    }
    ...
    public function destroy(InstallmentStatus $installmentStatus)
    {
        ...
        return redirect()
            ->route('installment_statuses.index')
            ->with('success', __('lookups::messages.installment_statuses.deleted'));
    }
}
