...
class NationalityController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
            ...
            ->with('success', __('lookups::messages.nationalities.created'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()
            ->route('nationalities.index')
            ->with('success', __('lookups::messages.nationalities.updated'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()
            ->route('nationalities.index')
            ->with('success', __('lookups::messages.nationalities.deleted'));
    }
}
