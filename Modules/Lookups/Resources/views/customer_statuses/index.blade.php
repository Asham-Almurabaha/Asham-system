...
<div class="container-xxl py-4">
    <div class="d-flex flex-wrap align-items-center gap-3 mb-4">
        ...
        <div class="ms-auto d-flex flex-wrap gap-2">
            <a href="{{ route('customer_statuses.create') }}" class="btn btn-success">
                ...
                <tr>
                    ...
                    <td class="text-end">
                        <div class="d-inline-flex gap-2">
                            <a href="{{ route('customer_statuses.edit', $status->id) }}" class="btn btn-sm btn-outline-primary">{{ __('Edit') }}</a>
