        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-2">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('Nationalities') }}</li>
                </ol>
            </nav>
            <h1 class="h4 mb-0">{{ __('Nationalities List') }}</h1>
        </div>
        <div class="ms-auto d-flex flex-wrap gap-2">
            <x-button.action href="{{ route('nationalities.create') }}" variant="success">
                ...
                <tr>
                    ...
                    <td class="text-end">
                        <div class="d-inline-flex gap-2">
                            <x-button.action href="{{ route('nationalities.edit', $nationality->id) }}" variant="primary" :outline="true" size="sm">{{ __('Edit') }}</x-button.action>
