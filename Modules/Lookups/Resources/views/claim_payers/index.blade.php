...
<div class="container-xxl py-4">
    ...
    <div class="card border-0 shadow-sm">
        <x-table head-class="table-light">
                ...
                <tr>
                    ...
                    <td class="text-end">
                        <div class="d-inline-flex gap-2">
                            <x-button.action href="{{ route('claim_payers.edit', $claimPayer->id) }}" variant="primary" :outline="true" size="sm">{{ __('Edit') }}</x-button.action>
            ...
            @empty
                <tr>
                    <td colspan="3" class="text-center text-muted py-4">{{ __('No claim payers found.') }}</td>
                </tr>
            @endforelse
        </x-table>
    </div>
