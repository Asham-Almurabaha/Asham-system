...
<div class="container-xxl py-4">
    <div class="d-flex flex-wrap align-items-center gap-3 mb-4">
        ...
        <div class="ms-auto d-flex flex-wrap gap-2">
            <x-button href="{{ route('claim_payers.create') }}" variant="success">
                ...
                <tr>
                    ...
                    <td class="text-end">
                        <div class="d-inline-flex gap-2">
                            <x-button href="{{ route('claim_payers.edit', $claimPayer->id) }}" variant="primary" :outline="true" size="sm">{{ __('Edit') }}</x-button>
