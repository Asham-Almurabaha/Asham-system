...
<div class="pagetitle">
    <h1>{{ __('Installment Types List') }}</h1>
    <nav>
        <ol class="breadcrumb">
            <li class="breadcrumb-item">{{ __('Settings') }}</li>
            <li class="breadcrumb-item active">{{ __('Installment Types') }}</li>
        </ol>
    </nav>
</div><!-- End Page Title -->
...
<div class="card d-inline-block mb-3">
    <div class="card-body p-20">
        <a href="{{ route('installment_types.create') }}" class="btn btn-success">{{ __('Add New Installment Type') }}</a>
    </div>
</div>
        ...
        <div class="card-body p-20">
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="3" class="text-center">{{ __('No installment types found.') }}</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
