                ...
                <div class="card-body p-4">
                    <form action="{{ route('company-disbursement-statuses.update', $status) }}" method="POST" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="description" rows="3" class="form-control @error('description') is-invalid @enderror" placeholder="{{ __('companies::companies.Description Placeholder') }}">{{ old('description', $status->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-check form-switch mb-4">
                            <input class="form-check-input" type="checkbox" role="switch" id="is_default" name="is_default" value="1" {{ old('is_default', $status->is_default) ? 'checked' : '' }}>
