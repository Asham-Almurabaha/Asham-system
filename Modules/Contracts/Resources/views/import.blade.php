  ...
  @if ($errors->any())
    <div class="alert alert-danger border-0 shadow-sm">
      <div class="d-flex align-items-start">
        ...
        <div>
          <div class="fw-semibold mb-1">@lang('contracts::contracts_import.Operation failed:')</div>
      ...
      <form action="{{ route('contracts.import') }}" method="POST" enctype="multipart/form-data" class="row g-3">
        ...
        <div class="col-12">
          <div id="dropzone" class="dz border border-2 border-dashed rounded-3 p-4 text-center">
            ...
            <div class="mb-2 fw-semibold">@lang('contracts::contracts_import.Drag file here or click to choose')</div>
            <div class="text-muted small mb-3">@lang('contracts::contracts_import.Excel/CSV only — validation before save')</div>
            ...
            <div class="small">
              <span class="text-secondary">@lang('contracts::contracts_import.Selected file:')</span>
