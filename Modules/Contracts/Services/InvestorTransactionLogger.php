...
class InvestorTransactionLogger
{
    ...
    private array $typeSynonyms = [
        ...
        'سداد مطالبة' => ['سداد قسط', 'تحصيل قسط', 'تحصيل', 'وارد', 'ايداع', 'إيداع'],
        'سداد مطالبه' => ['سداد قسط', 'تحصيل قسط', 'تحصيل', 'وارد', 'ايداع', 'إيداع'],
        'سداد مطالبة للمستثمرين' => ['سداد قسط', 'تحصيل قسط', 'تحصيل', 'وارد', 'ايداع', 'إيداع'],
        'سداد مطالبه للمستثمرين' => ['سداد قسط', 'تحصيل قسط', 'تحصيل', 'وارد', 'ايداع', 'إيداع'],
    ];
